...
export default async function Admin() {
  ...
  return <section className="admin-shell">
    <aside className="admin-nav"><Link className="wordmark" href="/">refurb<span>shield</span></Link><p>ADMINISTRATION</p><Link href="/admin">Overview</Link><Link href="/admin/products">Products</Link><Link href="/admin/categories">Categories</Link><Link href="/admin/brands">Brands</Link><Link href="/admin/collections">Collections</Link><Link href="/admin/inventory">Inventory</Link><Link href="/admin/orders">Orders</Link><Link href="/admin/customers">Customers</Link><Link href="/admin/coupons">Coupons</Link><Link href="/admin/reviews">Reviews</Link><Link href="/admin/payments">Payments</Link><Link href="/admin/shipping">Shipping</Link><Link href="/admin/tax">GST & tax</Link><Link href="/admin/analytics">Analytics</Link><Link href="/admin/storefront">Storefront</Link><Link href="/admin/settings">Settings</Link><Link href="/admin/users">Users & roles</Link><Link href="/admin/audit-logs">Audit logs</Link></aside>
