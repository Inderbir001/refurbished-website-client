...
export default function RootLayout({ children }: Readonly<{ children: React.ReactNode }>) { return <html lang="en"><body><div className="scroll-progress" aria-hidden="true" /><ScrollReveal /><Header /><main>{children}</main><Footer /></body></html>; }
